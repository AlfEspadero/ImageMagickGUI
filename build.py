...
def test_package():
    ...
    # Test import
    if not run_command(f"{sys.executable} -c 'import main; print(\"✅ Module imports successfully\")'", 
    ...
    if wheel_files:
        ...
        if not run_command(f"{sys.executable} -m pip install --dry-run {wheel_file}", 
