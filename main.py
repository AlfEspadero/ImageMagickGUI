...
class ImageMagickGUI:
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="ImageMagick GUI Converter", 
                               font=("Arial", 16, "bold"))
        title_label.grid(row=0, column=0, columnspan=3, pady=(0, 20))
        
        # Input file selection
        ttk.Label(main_frame, text="Input File:").grid(row=1, column=0, 
                                                       sticky=tk.W, pady=5)
        
        input_entry = ttk.Entry(main_frame, textvariable=self.input_file_path,
                               state="readonly", width=50)
        input_entry.grid(row=1, column=1, sticky=(tk.W, tk.E), 
                        padx=(10, 5), pady=5)
        ...
        # Convert button
        self.convert_btn = ttk.Button(main_frame, text="Convert Image", 
        ...
        # Output info frame
        info_frame = ttk.LabelFrame(main_frame, text="Conversion Info", 
                                   padding="10")
        info_frame.grid(row=7, column=0, columnspan=3, 
        ...
        self.output_text = tk.Text(text_frame, height=8, width=70, 
    ...
    def check_imagemagick(self):
        ...
        try:
            ...
            try:
                ...
                self.status_label.config(text="ImageMagick not found", 
                                       foreground="red")
    ...
    def _conversion_complete(self, success, output_path):
        ...
        if success and os.path.exists(output_path):
            ...
            messagebox.showerror("Error", 
                               "Image conversion failed. Check the log for details.")
